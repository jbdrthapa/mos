...
export function WeatherDetailWidget() {
    ...
    const cityWeather = createComputed(() => `${city()}  :  ${description()}`);
        ...
        <box orientation={Gtk.Orientation.VERTICAL} spacing={10}>
            <box orientation={Gtk.Orientation.HORIZONTAL}>
                ...
                <label
                    ...
                    label={createBinding(weatherService, "temperature")}
                    cssName="detail-weather-temp"
                />
            </box>
            ...
            <box orientation={Gtk.Orientation.VERTICAL} spacing={8}>
                ...
                <box hexpand={true} halign={Gtk.Align.START}>
                    ...
                    <label xalign={0} label={createBinding(weatherService, "wind_speed").as(String)} cssName="detail-weather-details-value" />
                </box>

                <box hexpand={true} halign={Gtk.Align.START}>
                    <label xalign={0} label="Wind Direction" cssName="detail-weather-details-label" />
                    <label xalign={0} label={createBinding(weatherService, "wind_direction").as(String)} cssName="detail-weather-details-value" />
                </box>
            </box>
        </box>
    );
